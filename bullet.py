...
class Bullet(Sprite):
    ...
    def __init__(self, current_game):
        ...
        self.rect.midtop = current_game.survivor.image_rect.midtop
        ...
        self.vec_x = self.mouse_pos_x - self.rect.x
        self.vec_y = self.mouse_pos_y - self.rect.y
    ...
    def update(self):
        ...
        """
        # Commented out testing expressions
        # self.i = 0
        # self.i += 1
        # print(f"i = {self.i}")
        self.rect.move_ip(self.vec_x/self.settings.bullet_speed, self.vec_y/self.settings.bullet_speed)
